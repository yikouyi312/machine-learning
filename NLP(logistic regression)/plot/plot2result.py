...
num_epoch = 5000
learning_rateset = [0.0001, 0.00001, 0.000001]
...
count = 0
for learning_rate in learning_rateset:
    count += 1
    ...
    if count == 1:
        train_log1 = train_log
    elif count == 2:
        train_log2 = train_log
    else:
        train_log3 = train_log
...
blue_line = plt.plot(num, train_log1, color='blue', label='learning_rate = 0.0001')
red_line = plt.plot(num, train_log2, color='red',  label='learning_rate = 0.00001')
green_line = plt.plot(num, train_log3, color='green',  label='learning_rate = 0.000001')
